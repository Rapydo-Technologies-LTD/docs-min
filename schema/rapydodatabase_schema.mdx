...
_-- Find currently long-running queries_
...
_-- Find slowest queries in the last 24 hours_
...
_-- Get readable SQL for query patterns_
...
_-- Current database health overview_
...
_-- Dashboard-ready database performance summary_
...
_-- Top slow queries from yesterday_
...
_-- Query performance trends over multiple days_
...
_-- Good: Uses time partitioning_
...
_-- Efficient multi-tenant query_
...
_-- Standard pattern for readable queries_
...
_-- Find queries that suddenly became slow_
...
WHERE r.recent_avg \> h.historical_avg \* 2  _-- 2x slower than usual_
