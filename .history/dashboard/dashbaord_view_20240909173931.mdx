...
This widget displays the time range for the data represented in the graphs and metrics. In this case, it is set to show performance and activity from the last 3 / 6 / 12 /    hours. This can be adjusted based on the user's needs.
