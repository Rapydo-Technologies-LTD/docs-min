...
Triggers AI-powered query analysis for queries matching the trigger conditions. Results include root cause identification and complete remediation plan sent via email.
...
- Complete analysis report is emailed to configured recipients
...
**Email:** Enter one or more notification email addresses (comma-separated)
